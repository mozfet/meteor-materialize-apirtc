...
const fullstackConfig =  require(fullstackConfigFilePath)

// define project name
const project_name = fullstackConfig.projectName

// derive projects folder
const dir_projects = fullstackConfig.userFolder + '/' +
    fullstackConfig.projectsFolder
